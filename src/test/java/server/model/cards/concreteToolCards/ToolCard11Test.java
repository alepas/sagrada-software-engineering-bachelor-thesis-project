...
public class ToolCard11Test {
    ...
    public void Before() throws CannotPickDiceException {
        ...
        when(chosenDiceMiddleNumber.getDiceColor()).thenReturn(Color.RED);
        ...
        when(chosenDiceMiddleNumber.getDiceColor()).thenReturn(Color.GREEN);
...
/**
    ...
    public void placeDiceIllegalStatusTest() throws CannotPickDiceException, CannotPerformThisMoveException {
        toolCard11.placeDice(chosenDiceMiddleNumber.getId(),);
    }
