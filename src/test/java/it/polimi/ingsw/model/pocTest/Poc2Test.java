...
import it.polimi.ingsw.model.cards.concretePublicObjectiveCards.PublicObjectiveCard2;
...
public class Poc2Test {
    private PublicObjectiveCard2 card;
    private Wpc wpc;
    ...
    public void poc2Test(){
        Assert.assertEquals(2*POCConstants.POC2_SCORE, card.calculateScore(wpc));
    }
}
