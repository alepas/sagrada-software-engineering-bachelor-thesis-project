...
import it.polimi.ingsw.model.cards.concretePublicObjectiveCards.PublicObjectiveCard5;
...
public class Poc5Test {
        private PublicObjectiveCard5 card;
        private WPC wpc;
        ...
        public void poc5Test(){
            Assert.assertEquals(POCConstants.POC5_SCORE, card.calculateScore(wpc));
        }
}
