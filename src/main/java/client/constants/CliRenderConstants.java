...
public class CliRenderConstants {
    ...
    // Background
    public static String RED_BACKGROUND = "\033[0;101m";// RED
    public static String GREEN_BACKGROUND = "\033[42m";  // GREEN
    public static String YELLOW_BACKGROUND = "\033[0;103m";// YELLOW
    public static String BLUE_BACKGROUND = "\033[0;104m";// BLUE
