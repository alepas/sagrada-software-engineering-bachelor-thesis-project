...
public abstract class NetworkClient implements ResponseHandler {
    ...
    public abstract NextAction interruptToolCard(String userToken, ToolCardInterruptValues value) throws  CannotFindPlayerInDatabaseException, PlayerNotAuthorizedException, CannotInterruptToolCardException, NoToolCardInUseException;
