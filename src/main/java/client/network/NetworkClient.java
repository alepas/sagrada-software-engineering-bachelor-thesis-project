...
public abstract class NetworkClient implements ResponseHandler {
    ...
    public abstract NextAction interuptToolCard(String userToken, ToolCardInterruptValues value) throws  CannotFindPlayerInDatabaseException, PlayerNotAuthorizedException, CannotInterruptToolCardException, NoToolCardInUseException;
