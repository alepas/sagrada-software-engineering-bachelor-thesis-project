...
public class DatabaseUsersTEST {
    ...
    private static DatabaseUsersTEST instance=null ;

    private static ConcurrentHashMap<String, UserInDB> userDataTable=null;

    private static ConcurrentHashMap<String, String> tokenbyUsername = new ConcurrentHashMap<>();
    private static ConcurrentHashMap<String, UserInDB> usersbyToken = new ConcurrentHashMap<>();


    public synchronized static DatabaseUsersTEST getInstance(){
        if (instance==null) {
            instance = new DatabaseUsersTEST();
            try {
