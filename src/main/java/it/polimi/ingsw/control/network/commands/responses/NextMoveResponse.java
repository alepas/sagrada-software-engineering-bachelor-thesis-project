...
public class NextMoveResponse implements Response {
    ...
    public NextMoveResponse(ClientNextActions nextAction, ClientDiceLocations wherePickNewDice, ClientDiceLocations wherePutNewDice, ArrayList<Integer> numbersToChoose, ClientWpc wpc, ArrayList<ClientDice> extractedDices, ClientRoundTrack roundTrack, Integer diceChosenId, Exception exception) {
