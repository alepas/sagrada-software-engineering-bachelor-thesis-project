...
import server.constants.DiceBagCostants;
...
public class DiceBag {
    ...
    public DiceBag(){
        diceIdGenerator = 0;
        yellowDices = DiceBagCostants.INITIAL_DICE_NUMBER;
        redDices = DiceBagCostants.INITIAL_DICE_NUMBER;
        blueDices = DiceBagCostants.INITIAL_DICE_NUMBER;
        greenDices = DiceBagCostants.INITIAL_DICE_NUMBER;
        violetDices = DiceBagCostants.INITIAL_DICE_NUMBER;
    }
    ...
    public ArrayList<Dice> extractDices(int numPlayers){
        ...
        if(numPlayers == 1)
            numOfDices = DiceBagCostants.SOLO_PLAYER_DICES;
        else
