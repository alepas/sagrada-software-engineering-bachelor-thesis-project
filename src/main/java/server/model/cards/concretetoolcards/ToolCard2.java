...
public class ToolCard2 extends ToolCard {
    ...
    public MoveData placeDice(int diceId, Position pos) throws CannotPerformThisMoveException,
        ...
        if (!cardWpc.addDicePersonalizedRestrictions(tempDice, pos, false, true, true, true, false)) {
        ...
        currentGame.changeAndNotifyObservers(new ToolCardUsedNotification(username, this.getClientToolcard(),
